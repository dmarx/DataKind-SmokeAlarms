...
library(data.table)
library(magrittr)
source("E:/Projects/DataKind/SmokeAlarms/code/general_purpose/unbalanced_downsample.r")

#library(caret) # sonofabitch.
#library(DMwR) # godamnit.
#library(randomForest)
#library(RandomForest)
#library(randomforest)
# Well fuck. I guess I'm not doing this right now.
...
# Let's do a stack of logistic regressions
...
library(randomForest)
?randomForest
mod_casualty_rf = randomForest(x=train[,-"target", with=FALSE], 
